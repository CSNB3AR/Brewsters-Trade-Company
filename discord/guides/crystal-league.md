# Beginner Guide: Crystal League

Crystal League is the guild's main PvP focus, structured 5v5 and 20v20 competitive content. It's not the first thing to jump into though, it's end-game competitive content with real skill and gear expectations. Get comfortable elsewhere first.

## Before You Queue

Practice in the non-lethal Arena first, no item loss, and it's where you actually learn matchups and combos without financial risk. Get a build down, get comfortable with your combo, then step up.

## How It Works

- Sign up with Crystal League tokens, bought at the Energy Manipulator in the Conquerors' Hall of any major city.
