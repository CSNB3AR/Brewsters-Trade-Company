...
Personal progression plan. This is about the player character, not guild operations.
...
## Crafting / Economy Character Plan
...
- **Spectral Direboar** for solo Royal Continent travel. Invisibility works in the open world, not just instanced content.
- ZvZ/battle mount stays stabled, group content only. It's an expensive, slow gank magnet with a poor 1v1 profile solo, not because its abilities are disabled outside groups.

## Current Status

- 3.5 million silver
- Decent fame on the older character, not much yet on the newer one
- Last played around 2022
